...
if (document.querySelector(".ist-nav-mobilemenu-container li.menu-item")) {
  document
    .querySelectorAll(".ist-nav-mobilemenu-container li.menu-item")
    .forEach(function (element) {
      element.addEventListener("click", function () {
        document.documentElement.classList.remove("noscroll");
        document
          .querySelector(".ist-nav-outer")
          .classList.remove("ist-nav-mobilemenu-open");
        document
          .querySelector(".ist-nav-wrapper")
          .classList.remove("bg-spred");
      });
